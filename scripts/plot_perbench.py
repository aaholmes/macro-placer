...
ax.set_xlabel("IBM benchmark"); ax.set_ylabel("score (lower is better)")
ax.set_title(f"Final score per benchmark — avg {avg_ours:.4f} (−{100*(1-avg_ours/avg_ref):.0f}% vs reference, zero overlaps)")
